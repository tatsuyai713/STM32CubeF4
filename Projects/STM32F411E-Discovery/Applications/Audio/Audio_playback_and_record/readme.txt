...
This application shows how to use the different functionalities of Audio device
(CS43L22) and ST MEMS microphone (MP45DT02TR-M for Rev.A boards or IMP34DT05TR
for Rev.C boards) by switching between play and record audio using USER button.
...
2) Record audio. Device: "MP45DT02TR-M" / "IMP34DT05TR"
